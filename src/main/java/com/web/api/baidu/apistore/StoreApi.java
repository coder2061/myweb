...
public class StoreApi {
	...
	public static final String BAIDU_API_KEY = "90ffe6b645be6917e6ca9be3f7f91323";
	// 查询手机号的归属地信息。不收费，暂不限制峰值，大规模应用调用只需邮件apistore报备应用和联系人信息，否则视为恶意攻击禁止访问
	public static final String BAIDU_MOBILENUMBER = "http://apis.baidu.com/apistore/mobilenumber/mobilenumber?phone=%s";
	// 精准解读身份证信息，提供身份证归属地信息查询。不收费，如有大规模高并发调用，请邮件apistore@baidu.com报备联系人和app信息，否则视为恶意攻击禁止访问
	public static final String BAIDU_IDENTITY = "http://apis.baidu.com/apistore/idservice/id?id=%s";
