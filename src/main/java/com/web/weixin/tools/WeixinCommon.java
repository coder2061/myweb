...
import com.web.core.cache.CacheEntity;
import com.web.core.cache.CacheManager;
import com.web.utils.HttpUtil;
import com.web.weixin.config.WeixinConstants;
import com.web.weixin.model.AccessToken;
...
//		String result = HttpUtil.postClient(requestUrl, "GET", null);
	...
	public static String resetApiTicket(String appid, String appsecret) {
		...
		result = HttpUtil.postClient(requestUrl, "GET", null);
	...
	public String upload(String uploadType, String fileType, String filePath, 
		...
		String result = HttpUtil.httpPost(file, url);
		return result;
	}
	...
	public static String send(String uploadType, String fileType, String filePath, 
        ...
        return HttpUtil.postClient(url, file, params, fileType) ; 
    }
