...
public class MQProducer {
	...
	public static void sendMsg(String msg, String queueName) {
		...
		try {
			...
			closeAll(producer, session, connection);
		}
	}
	...
	private static void closeAll(MessageProducer producer, Session session,
	...
	private static void closeProducer(MessageProducer producer) {
		if (producer != null) {
			try {
				producer.close();
